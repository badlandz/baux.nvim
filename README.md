...
```sh
git clone https://github.com/badlandz/baux.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/badlandz/baux.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone https://github.com/badlandz/baux.git $env:USERPROFILE\AppData\Local\nvim\
```
